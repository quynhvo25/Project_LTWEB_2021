            ...
            <div class="page-container2">
                                    ...
                                    <div class="au-breadcrumb-content">
                                        <div class="au-breadcrumb-left">
                                            ...
                                            <ul class="list-unstyled list-inline au-breadcrumb__list">
                                                ...
                                                <li class="list-inline-item">Quản lí tài khoản</li>
                                            </ul>
                                        </div>
                ...
                <div class="container-table">
                    <div class="header-table">
                        <label class="title-table">Tài khoản</label>
        ...
        <div class="modal-container">
            ...
            <div class="header-modal-add">
               <span class="header-title">
                   <i class="hd-icon-modal fas fa-plus"></i>Thêm tài khoản</span>
            </div>
            ...
            <div class="modal-body">
                <table class="modal-table">
                    ...
                    <tr class="row-modal-2">
                        <td class="modal-td"> 
                            <input id="username" type="text" class="modal-input">
                        </td>
                        <td class="modal-td">
                            <input id="password" type="text" class="modal-input">
                        </td>    
                    </tr>
                ...
                <div class="active-radio">
                    ...
                    <div class="radio">
                        ...
                        <label for="radio-2" class="radio-label">User</label>
