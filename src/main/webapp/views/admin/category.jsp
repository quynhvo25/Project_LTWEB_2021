            ...
            <div class="page-container2">
                ...
                <div class="container-table">
                    <div class="header-table">
                        <label class="title-table">Danh mục sản phẩm</label>
        ...
        <div class="modal-container">
            ...
            <div class="header-modal-add">
               <span class="header-title">
                   <i class="hd-icon-modal fas fa-plus"></i>Thêm danh mục</span>
            </div>
        <div class="modal-body">
            <label for="id-catergory" class="modal-label">
                Mã danh mục
            </label>
            <input id="id-catergory" type="text" class="modal-input">

            <label for="name-category" class="modal-label">
                Tên danh mục
            </label>
            <input id="name-category" type="text" class="modal-input">
