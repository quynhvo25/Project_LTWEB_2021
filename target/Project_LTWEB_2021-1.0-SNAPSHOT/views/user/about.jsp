    ...
    <div class="row">
        <div class="col-lg-3">
            <div class="filter-about">
                <h4 class="fw-title">DANH MỤC TRANG</h4>
        ...
        <div class="col-lg-9">
            <div class="row-about">
            <p class="title-about">Giới thiệu</p>
                <p class="text-about">Chúng mình xuất hiện để đem tới mọi người một chất lượng áo tốt nhất, với giá thành hấp dẫn nhât
                để đưa UniShop đến với tất cả mọi lứa tuổi và khắp mọi miền đất nước.
                </p>
            </div>
        </div>
...
<script src="js/jquery.slicknav.j/ss"></script>
<script src="js/owl.carousel.min.js"><cript>
